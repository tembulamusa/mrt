            ...
            aria-labelledby="contained-modal-title-vcenter">
                    ...
                    <Modal.Body>
                        ...
                        <div className="row col-12">
                            <div className="col-3">
                            <a  className="resp-sharing-button__link" href={ `https://api.whatsapp.com/send?text=I%20placed%20this%20bet%20on%2035.189.72.196/.%20Cheki%20mkeka%20wangu%20na%20ubeti.%20https://35.189.72.196/share/${shareId}` } target="_blank" title="Share via Whatsapp">
                            ...
                            <div className="col-3">
                            <a className="resp-sharing-button__link" href={ `https://facebook.com/sharer/sharer.php?u=http://35.189.72.196/share/${shareId}`} target="_blank" rel="noopener" aria-label="Share on Facebook">
                            ...
                            <div className="col-3">
                            <a className="resp-sharing-button__link" href={ `https://twitter.com/intent/tweet/?text=I%20placed%20this%20bet%20on%20http://35.189.72.196/.%20Cheki%20mkeka%20wangu%20na%20ubeti&amp;url=http://35.189.72.196/share/${shareId}` } target="_blank" rel="noopener" aria-label="Share on Twitter">
                        ...
                        <h5> Copy Link </h5>
                        <ClipboardCopy copyText={`http://35.189.72.196//share/${shareId}` } />
