        ...
        <>
            ...
            <div className="amt">
                <div className="d-flex flex-row justify-content-between">
                            ...
                            <div className='col-md-12 primary-bg p-4 text-center'>
                              ...
                              <div className="col-md-12 p-2">
                                <div className="child-box-relative-pos">
                                    ...
                                    <div class="row section-block pl-3 pr-3">
                                        <div class="col-xs-6 col-sm-4 col-lg-3">
                                            <div class="circle-border text-center posa yellow counter-badge section-counter"></div>
                                            <div className="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                                <div className="col-xs-12 pg-3 border-radius-2">
                                                    <div className="col-xs-12 white-background center-container pg-0">
                                                                                                                                            <div class="col-xs-12 centered-content pg-0">
                                            ...
                                            <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                            ...
                                            <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                                <div class="col-xs-12 pg-3 border-radius-2">
                                                    <div class="col-xs-12 white-background center-container pg-0">
                                                                                                                                            <div class="col-xs-12 centered-content pg-0">
                                                                    <h3 class="center-text h3 bold wordwarp">101010</h3>
                                                                </div>
                                                                                                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-6 col-sm-4 col-lg-3">
                                            ...
                                            <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                                <div class="col-xs-12 pg-3 border-radius-2">
                                                    <div class="col-xs-12 white-background center-container pg-0">
                                                                                                                                            <div class="col-xs-12 centered-content pg-0">
                                                                    <h3 class="center-text h3 bold wordwarp">XXXXXXX</h3>
                                                                </div>
                                                                                                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-6 col-sm-4 col-lg-3">
                                            ...
                                            <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                                <div class="col-xs-12 pg-3 border-radius-2">
                                                    <div class="col-xs-12 white-background center-container pg-0">
                                                                                                                                            <div class="col-xs-12 centered-content pg-0">
                                                                    <h3 class="center-text h3 bold wordwarp">XX,XXX/=</h3>
                                                                </div>
                                                                                                                                </div>
                                                </div>
                                            </div>
                                    ...
                                    {/*How to deposit Tigo*/}
                                        <header class="yellow mb-4" style={{paddingLeft: "15px"}}>
                                        ...
                                        <div class="col-xs-6 col-sm-4 col-lg-3">
                                            ...
                                            <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                                <div class="col-xs-12 pg-3 border-radius-2">
                                                    <div class="col-xs-12 white-background center-container pg-0">
                                                                                                                                            <div class="col-xs-12 centered-content pg-0">
                                                                    <h3 class="center-text h3 bold wordwarp">*150*01#</h3>
                                                                </div>
                                                                                                                                </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                                <div className="col-xs-12 pg-3 border-radius-2">
                                                    <div className="col-xs-12 white-background center-container pg-0">
                                                                                                                                            <div class="col-xs-12 pg-0 yellow centered-content">
                                                                    <ol className="">
                                                                                                                                <li class="bold ">4. Lipa kwa TIGOPESA</li>
                                                                                                                        </ol>
                                                                </div>
                                                                                                                                </div>
                                                </div>
                                ...
                                <div class="row section-block">
                                    ...
                                    <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                        <div class="col-xs-12 pg-3 border-radius-2">
                                            <div class="col-xs-12 white-background center-container pg-0">
                                                                                                                                    <div class="col-xs-12 centered-content pg-0">
                                                            <h3 class="center-text h3 bold wordwarp">*150*60#</h3>
                                                        </div>
                                                                                                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                        <div class="col-xs-12 pg-3 border-radius-2">
                                            <div class="col-xs-12 white-background center-container pg-0">
                                                                                                                                    <div class="col-xs-12 pg-0 yellow centered-content">
                                                            <ol class="">
                                                                                                                        <li class="bold ">5. Lipa kwa Airtel Money</li>
                                                                                                                </ol>
                                                        </div>
                                                                                                                        </div>
                                        </div>
                    ...
                    <header class="yellow pg-10 mb-4" style={{paddingLeft: "15px"}}>
                        ...
                        <div class="col-xs-6 col-sm-4 col-lg-3">
                            ...
                            <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                <div class="col-xs-12 pg-3 border-radius-2">
                                    <div class="col-xs-12 white-background center-container pg-0">
                                                                                                                            <div class="col-xs-12 centered-content pg-0">
                                                    <h3 class="center-text h3 bold wordwarp">www.bikosports.co.tz</h3>
                                                </div>
                                                                                                                </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 secondary-bg mg-2 yellow pg-0 border-radius-2">
                                <div class="col-xs-12 pg-3 border-radius-2">
                                    <div class="col-xs-12 white-background center-container pg-0">
                                                                                <div class="col-xs-12 pg-0 ovh" style={{height: "125px"}}>
