        ...
        <AccordionItem>
            ...
            <AccordionItemPanel className='accordion-item-panel'>
                <ol>
                    ...
                    <li> All CLIENTS accessing the Bikosports’ website agree to abide by the
                    ...
                    <li> This Agreement describes the terms, conditions and risks applicable
                        ...
                        of
                        www.bikosports.com (the "SITE" If the CLIENT has any questions
                        regarding
                    ...
                    <li> The CLIENT must read, agree with, and accept all of the terms and
                        ...
                        registered CLIENT of Bikosports. By continuing to access or use the
                        SITE,
                    ...
                    <li> Bikosports will not be liable in any way to any persons in the event
                        of
                    ...
                    <li> Bikosports will not be responsible for any saturation of the
                    ...
                    <li> Bikosports will not be held liable and will be held harmless by the
                    ...
                    <li> Bikosports may assign this Agreement or any rights and/or obligations
                        hereunder without the CLIENT’s consent.
                    </li>

                    <li> Bikosports may amend the terms of this Agreement from time to time by
                        posting the amended terms on the WEBSITE. The CLIENT continuing
                        usage of
                        Bikosports’ services after the date of amendment is acceptance of the
                    ...
                    <li> The CLIENT will ultimately be responsible for checking the
                        ...
                        sending an email to customercare@bikosports.com. The company will cease to
                        have
                    ...
                    <li> Bikosports undertakes to respect the CLIENT’s privacy in line with the
