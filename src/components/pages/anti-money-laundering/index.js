...
transactions, and all legal requirements and Bikosports’s compliance policies and procedures; and </li>
    ...
    <p>Bikosports will implement the following strategies in addressing AML compliance:</p>
    <p><b>AML Risk Management</b></p>
    <p>a) As part of Bikosports’s Enterprise Risk Management Framework, risks as a result of ML/TF will be identified, assessed, evaluated, treated, monitored and reported regularly.</p>
    ...
    <ul>
    <li>What are the entry and exit points at Bikosports for funds that may come from illicit sources?</li>
    <li>What Bikosports departments or employees are best positioned to detect the entry and exit of such funds?</li>
    ...
    <li>What mitigation measures or elimination measures can Bikosports employ? </li>
    </ul>
...
transactions.</p>
    ...
    <p>c) Where identification or registration documents are unavailable or found to be falsified, Bikosports will deny or sever the business arrangement as per contract terms. </p>
    <p>d) Bikosports will carry out regular due diligence local and world checks to identify persons of disreputable character, politically exposed persons as well as persons or corporations on sanctions or other ML/TF watch lists. If such persons or corporations are identified, Bikosports will review the engagement and take appropriate action to limit the company’s exposure topotential ML/TF activities. </p>
    <h1>Transaction Monitoring</h1>
    <p>a) Bikosports will actively monitor and carry out regular analysis of money transfers transactions to identify suspicious or unusual activities that could point to ML/TF activities.</p>
